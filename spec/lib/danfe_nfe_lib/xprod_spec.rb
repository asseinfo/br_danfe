...
describe BrDanfe::DanfeNfeLib::Xprod do
  describe '#render' do
    context 'when has FCI' do
      ...
      subject { BrDanfe::DanfeNfeLib::Xprod.new(xml_fci) }
    ...
    context 'when has ST' do
      context 'when is Retido' do
        ...
        subject { BrDanfe::DanfeNfeLib::Xprod.new(xml) }
      ...
      context "when isn't Retido" do
        ...
        subject { BrDanfe::DanfeNfeLib::Xprod.new(xml_st) }
    ...
    context 'when has infAdProd' do
      ...
      subject { BrDanfe::DanfeNfeLib::Xprod.new(xml_infAdProd) }
    ...
    context 'when has FCP on ICMS00 tag' do
      ...
      subject { BrDanfe::DanfeNfeLib::Xprod.new(xml_fcp) }
    ...
    context 'when has FCI + ST + infAdProd + FCP' do
      ...
      subject { BrDanfe::DanfeNfeLib::Xprod.new(xml_IFC_ST_infAdProd) }
